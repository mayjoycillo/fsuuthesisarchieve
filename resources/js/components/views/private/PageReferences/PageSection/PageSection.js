...
export default function PageSection() {
    ...
    const { data: dataSource, refetch: refetchSource } = GET(
        `api/ref_section?${new URLSearchParams(tableFilter)}`,
        "section_list"
    );
    ...
    const { mutate: mutateDeleteSection, loading: loadingDeleteSection } =
        DELETE(`api/ref_section`, "section_list");
